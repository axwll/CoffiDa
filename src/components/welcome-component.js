    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                <Text style={styles.title_dark}>Coffi<Text style={styles.title_primary}>Da</Text></Text>
                <Text style={styles.heading_dark}>Welcome</Text>
                <Text style={styles.text_dark}>You're only a couple of steps away from coffee!</Text>
                <Text style={styles.text_primary}>Already have an account?</Text>

                <View style={styles.btn_view}>
                    <TouchableOpacity style={styles.btn_primary} onPress={() => this.logIn()}>
                ...
                <View style={styles.btn_view}>
                    <TouchableOpacity style={styles.btn_secondary} onPress={() => this.logIn()}>
